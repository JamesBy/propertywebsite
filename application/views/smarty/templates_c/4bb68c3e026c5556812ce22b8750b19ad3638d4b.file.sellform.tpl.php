<?php /* Smarty version Smarty-3.1.15, created on 2013-12-21 18:34:20
         compiled from "application\views\smarty\templates\sellform.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3063526583cbbf6802-84997076%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '3063526583cbbf6802-84997076',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_526583cbce4c81_21780050',
  'variables' => 
  array (
    'flashMessage' => 0,
    'sellerOptions' => 0,
...
<?php if ($_valid && !is_callable('content_526583cbce4c81_21780050')) {function content_526583cbce4c81_21780050($_smarty_tpl) {?>
<?php if ((isset($_smarty_tpl->tpl_vars['flashMessage']->value)&&strlen(trim($_smarty_tpl->tpl_vars['flashMessage']->value))>0)) {?>
    <div id="alertDiv" class="alert alert-success">
        ...
        <strong>Message: <?php echo $_smarty_tpl->tpl_vars['flashMessage']->value;?>
</strong>
    </div>
<?php }?>
<<?php ?>?//php endif; ?<?php ?>>
...
<div class="container">
        ...
        <div class="form-group" id="sellerDiv" name="sellerDiv">
            ...
            <div class="col-md-offset-7"> 
                <select class="form-control" id="sbSeller" name="sbSeller" form="searchform">
                    ...
                    <?php echo $_smarty_tpl->tpl_vars['sellerOptions']->value;?>
    ...
    <form   class="form-horizontal" name="searchform" id="searchform" action="addHouse.php" method="POST" enctype="multipart/form-data">    
        ...
        <?php echo $_smarty_tpl->tpl_vars['fieldValues']->value['id'];?>

        <?php echo $_smarty_tpl->tpl_vars['fieldValues']->value['updateImage'];?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-offset-7"> 
                <input type="text" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['fieldValues']->value['address'];?>
" name="tiAddress" style="width:100%;">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-offset-7"> 
                <input type="number" class="form-control" name="tiAskingPrice" id="tiAskingPrice" value="<?php echo $_smarty_tpl->tpl_vars['fieldValues']->value['price'];?>
" >
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-offset-7">
                <textarea class="form-control" rows="3" name="taDescription" id="taDescription"><?php echo $_smarty_tpl->tpl_vars['fieldValues']->value['description'];?>
</textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-md-offset-7">
                <?php echo $_smarty_tpl->tpl_vars['fieldValues']->value['image'];?>
...
smarty variables. To solve this I will declare some java script here-->
    ...
    $(window).load(function() {  
        ...
        $("#sbLocArea option[value='<?php echo $_smarty_tpl->tpl_vars['fieldValues']->value['county'];?>
']").attr('selected','selected'); 
        $("#sbHouseType option[value='<?php echo $_smarty_tpl->tpl_vars['fieldValues']->value['housetype'];?>
']").attr('selected','selected'); 
        $("#sbNoOfRooms option[value='<?php echo $_smarty_tpl->tpl_vars['fieldValues']->value['numrooms'];?>
']").attr('selected','selected'); 
        $("#sbSeller option[value='<?php echo $_smarty_tpl->tpl_vars['fieldValues']->value['sellerid'];?>
']").attr('selected','selected');
    });
    </script>
